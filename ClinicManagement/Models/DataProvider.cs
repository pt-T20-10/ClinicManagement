...
namespace ClinicManagement.Models
{
    ...
    public class DataProvider
    {
        ...
        //private readonly string _connectionString = @"Data Source=ACER\MSSQLSERVER03;Initial Catalog=QuanLyKhoKteam;Integrated Security=True;Trust Server Certificate=True;MultipleActiveResultSets=True";

        //// Instance của DbContext để sử dụng Entity Framework
        //private QuanLyKhoContext _dbContext;
        ...
        //{
        //    // Khởi tạo DbContext
        //    var options = new DbContextOptionsBuilder<QuanLyKhoContext>()
        //        .UseSqlServer(_connectionString)
        //        .Options;

        //    _dbContext = new QuanLyKhoContext(options);
        //}

 
        ///// Trả về DbContext instance cho EF operations
       
        //public QuanLyKhoContext Context => _dbContext;
